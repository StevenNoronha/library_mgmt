...
void displayl()
{
    ...
    {
        printf("----------------------------------------------\n");
        printf("\n%s\t%s\t%s\t%s\t\n",cur1->newl->name,cur1->newl->author,cur1->newl->pub,cur1->newl->price);
        printf("----------------------------------------------\n");
        cur1->newl=cur1->newl->link1;
...
void display()
{
    ...
    {
        printf("--------------------------------------------------------------------------\n");
        printf("%s %16s %16s %16s %16d\n",temp1->name,temp1->author,temp1->pub,temp1->price,temp1->num);
        //printf("\n%s\t||\t%s\t||\t%s\t||\t%s\t||\t\t\n",temp1->name,temp1->author,temp1->pub,temp1->price);
        //printf("----------------------------------------------\n");
        temp1=temp1->link1;
    }
}
...
void displays()
{
    ...
    {
        printf("----------------------------------------------\n");
        printf("\n%s\t%s\t%s\t%d\t\n",temp1->sname,temp1->usn,temp1->branch,temp1->sem);
        printf("----------------------------------------------\n");
        temp1=temp1->links;
    }
}
...
void search()
{
    ...
    printf("Search successful, book found at position : %d\n", count);
    printf("\nName : %s\nAuthor : %s\nPublication : %s\nPrice : %s\n",cur->name,cur->author,cur->pub,cur->price);
}
...
int main()
{
    ...
    while(1)
    {
        ...
        switch(ch)
        {
            case 1 : printf("Enter number of books to be added :\n");
                     scanf("%d",&n);
                     for(i=1;i<=n;i++)
                     {
                     ...
                     break;
            case 2 : printf("Enter number of students to be added :\n");
                     scanf("%d",&n);
                     for(i=1;i<=n;i++)
                     {
